...
export default function Decoration() {
  ...
  const totalPages = Math.ceil(decorationServices.length / ITEMS_PER_PAGE);

  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;

  const currentServices = decorationServices.slice(
    startIndex,
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-gold/15 via-ivory to-ivory pt-32 pb-16 sm:pt-25 sm:pb-5">
        ...
        <div className="pointer-events-none absolute -bottom-32 -left-32 h-80 w-80 rounded-full bg-rose/10 blur-3xl" />
      ...
      <section className="bg-ivory py-16 sm:py-24">
        <div className="container-x">
          <SectionHeading
            ...
            title="We Decorate Every Celebration"
            description="Choose a decoration service and tell us about your event. Our team will help you create a setup that matches your occasion, venue and style."
          />
      ...
      <section className="relative overflow-hidden bg-cream/50 py-16 sm:py-20">
        ...
        <div className="container-x relative mx-auto max-w-2xl text-center">
          <SectionHeading
            ...
            description="Tell us your event date, venue, guest count and preferred decoration style. We'll help you plan the perfect setup."
          />
